...
echo -e "═════════════════════════════════════════════\e[m" | lolcat
echo -e "$bd 1$bl] \e[m $bdSet Auto-Reboot Setiap 1 O'clock"
echo -e "$bd 2$bl] \e[m $bdSet Auto-Reboot Setiap 6 O'clock"
echo -e "$bd 3$bl] \e[m $bdSet Auto-Reboot Setiap 12 O'clock"
echo -e "$bd 4$bl] \e[m $bdSet Auto-Reboot Setiap 1 Day"
echo -e "$bd 5$bl] \e[m $bdSet Auto-Reboot Setiap 1 Sunday"
